...
class EmployeeModel extends Database
{
    ...
    /*
     * Lấy ra một bản ghi hay một nhân viên
     * @param $id
     *
     * */
    ...
    public function insert($data)
    {
        if (isset($data['name']) && isset($data['address']) && isset($data['salary']))
        {
            ...
            $sqlInsert = "INSERT INTO $this->table (name, address, salary) VALUE ('$name', $address, $salary)";
